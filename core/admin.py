...
from core.models import Season, EventReference, EventEdition, DistanceCategory, StageDistanceDefault, Race, Sport, Contact, Federation, Label, Location, Organizer
